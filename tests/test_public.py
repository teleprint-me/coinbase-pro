...
# public
from coinbase_pro.client import Product
from coinbase_pro.client import Currency
from coinbase_pro.client import Time
...
class TestPublicClient(object):
    def test_public_instance(self, public_client):
        ...
        assert isinstance(public_client, Client)
